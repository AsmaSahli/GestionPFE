...
import DashRechercheEncadreur from '../components/DashRechercheEncadreur';
    ...
    return (
        ...
        {tab === 'Soutenance' && currentUser.role=='etudiant' && <DashSoutenanceEtdudiant />}
        {tab === 'Soutenance'&& currentUser.role=='enseignant' && <DashSoutenanceEnseignant/>}
        {tab === 'Soutenance' && currentUser.role=='responsable'&& <DashSoutenanceResponsable />}
